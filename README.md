...
The Eichler-Shimura relations [[1]](#1) are given as follows: for $0\leq t\leq \kappa-2$, we have that
...
Using \eqref{eq:ES1}, for $t \leq \frac{\kappa - 2}{2}$, the equation \eqref{eq:ES2} can be rewritten as
...
Similarly, using \eqref{eq:ES1}, for $t \leq \frac{\kappa -2}{2}$, the equation \eqref{eq:ES3} can be rewritten as
