...
Using the first relation, for $t \leq \frac{\kappa - 2}{2}$, the second relation can be rewritten as
...
Similarly, using the first relation, for $t \leq \frac{\kappa -2}{2}$, the third relation can be rewritten as
